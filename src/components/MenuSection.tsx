...
const MenuSection = () => {
  ...
  // change this date to when you want the badge to disappear
  const NEW_ITEM_EXPIRES_AT = new Date("2026-05-01T00:00:00");
  const showMiniPancakeBadge = new Date() < NEW_ITEM_EXPIRES_AT;
      ...
      <div className="container max-w-2xl">
        ...
        {loading ? (
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {categories.map((cat) => {
              const isMiniPancake = cat.id === "mini-pan-cake";
                  ...
                  <AccordionTrigger className="text-lg font-display font-semibold hover:no-underline py-5">
                    <span className="flex items-center gap-3">
                      ...
                      <span className="flex items-center gap-2">
                        ...
                        {isMiniPancake && showMiniPancakeBadge && (
